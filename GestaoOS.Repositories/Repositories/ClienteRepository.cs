...
using GestaoOS.Domain.Interface;
using GestaoOS.Domain.ValueObject;
using GestaoOS.Infrastructure.Database;
using Npgsql;
using System;
    ...
    public sealed class ClienteRepository : IClienteRepository {
        ...
        public async Task<IReadOnlyCollection<Cliente>> PesquisarAsync(string nome, string documento, bool? ativo) {
            ...
            if (!string.IsNullOrWhiteSpace(nome)) {
                ...
                parametros.Add(new NpgsqlParameter("nome", $"%{nome}%"));
            }
            ...
            if (!string.IsNullOrWhiteSpace(documento)) {
                ...
                parametros.Add(new NpgsqlParameter("documento", documento));
            }
        ...
        private Cliente MapearCliente(NpgsqlDataReader reader) {
            ...
            var documento = Documento.Reconstruir(reader.GetString(reader.GetOrdinal("documento")));
            var email = Email.Reconstruir(reader.GetString(reader.GetOrdinal("email")));
            var telefone = Telefone.Reconstruir(reader.GetString(reader.GetOrdinal("telefone")));
            ...
            return Cliente.Reconstruir(
                ...
                reader.GetDateTime(reader.GetOrdinal("data_cadastro")));
        }
    }
}